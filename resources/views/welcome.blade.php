...
@section('header')
    ...
    <div class="content" style="pointer-events: none; opacity: 0.7; background: #ccc; padding:10px; margin-top: 20px">
      <div class="links">
        <h1>Search Feature it's on Progress</h1>
      </div>
            ...
            <div class="row">
              <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                <div class="card card-statistic-1">
                  ...
                  <div class="card-wrap">
                    <div class="card-header">
                      <h4>Total Barang Keseluruhan</h4>
                    </div>
                    <div class="card-body">
                      {{$tot}}
                    </div>
